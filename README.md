# Blockbuster Employee Management System
...
## Features
The management system will include multiple functons for seperate users depending on their level of management. These include the ability for an base store employee to enter and edit various demographic information, as well as view their work schedule and request days off. Also included is the ability for store managers to have access to greater access and control to make schedule edits, write performance reviews about eployees that only managers are allowed to view.
